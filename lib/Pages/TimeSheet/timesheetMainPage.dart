...
var finalHours = TextEditingController();

class TimesheetCard extends StatefulWidget {
  @override
  _TimesheetCardState createState() => _TimesheetCardState();
}
                                          ...
                                          SearchableDropdown.single(
                                            ...
                                            onChanged: (value) {
                                              setState(() {
                                                ...
                                                createModel.screenObject.activityid=arr[0];
                                                createModel.screenObject.activityname=arr[1];
                                                createModel.screenObject.subprojectid=arr[2];
                                                createModel.screenObject.subprojectname=arr[3];
                                                createModel.screenObject.projectid=arr[4];
                                                createModel.screenObject.projectname=arr[5];
