...
import 'package:fit_timesheets/models/admin/Activities/activitiesEntry.dart';
...
class ActivitiesEntryForm extends StatefulWidget {
  @override
  ActivitiesEntryFormState createState() => ActivitiesEntryFormState();
}

class ActivitiesEntryFormState extends State<ActivitiesEntryForm> {
  ...
  ActivitiesEntry activitiesEntry=ActivitiesEntry();
  @override
                      ...
                      DatePicker.showDatePicker(context,
                          ...
                          onChanged: (date) {
                            ...
                            setState(() {
                              ...
                              activitiesEntry.screenObject.startdate=year+month+day;
                      ...
                      DatePicker.showDatePicker(context,
                          ...
                          onChanged: (date) {
                            ...
                            setState(() {
                              ...
                              activitiesEntry.screenObject.enddate=year+month+day;
                                ...
                                await Future.delayed(
                                  ...
                                  return showDialog<void>(
                                    ...
                                    builder: (BuildContext context) {
                                      activitiesEntry.language='E';
                                      activitiesEntry.mode='create';
                                      activitiesEntry.screenName='S0010';
                                      activitiesEntry.screenObject.activityid=_activityId.text;
                                      activitiesEntry.screenObject.name=_name.text;
                                      activitiesEntry.screenObject.description=_description.text;
...
child: ListBody(
children: <Widget>[Text('Activity id: ${_activityId.text}'),
  Text('Activity Name: ${_name.text}'),
  Text('Activity Description: ${_description.text}'),
