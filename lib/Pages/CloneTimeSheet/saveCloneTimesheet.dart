...
class SaveCloneTimeSheet extends StatefulWidget {
  final  TimeSheetData getTimeSheetModel;

  const SaveCloneTimeSheet({Key key, this.getTimeSheetModel}) : super(key: key);

  @override
  SaveCloneTimeSheetState createState() => SaveCloneTimeSheetState(getTimeSheetModel);
}

class SaveCloneTimeSheetState extends State<SaveCloneTimeSheet> {
  final  TimeSheetData getTimeSheetModel;
  ...
  SaveCloneTimeSheetState(this.getTimeSheetModel);
  double progress = 0.0;
                                                          ...
                                                          builder: (
                                                            ...
                                                            return AlertDialog(
                                                              backgroundColor: Colors
                                                                  .grey[350],
                                                              title: Text(
                                                                  'Records have been successfully cloned'),
                                                              content: SingleChildScrollView(
                                                                child: ListBody(
                                                                  children: <
                                                                      Widget>[
