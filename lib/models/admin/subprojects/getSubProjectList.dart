class GetSubProjectList {
  String status;
  Body body;

  GetSubProjectList({this.status, this.body});

  GetSubProjectList.fromJson(Map<String, dynamic> json) {
    status = json['status'];
...
class ScreenData {
  ...
  List<SubProjectMultiOccData> multiOccData;
  ...
  ScreenData.fromJson(Map<String, dynamic> json) {
    ...
    if (json['multiOccData'] != null) {
      multiOccData = new List<SubProjectMultiOccData>();
      json['multiOccData'].forEach((v) {
        multiOccData.add(new SubProjectMultiOccData.fromJson(v));
      });
    }
  }
...
class SubProjectMultiOccData {
  ...
  SubProjectMultiOccData.fromJson(Map<String, dynamic> json) {
