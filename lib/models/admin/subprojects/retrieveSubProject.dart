class RetrieveSubProject {
  String status;
  Body body;

  RetrieveSubProject({this.status, this.body});

  RetrieveSubProject.fromJson(Map<String, dynamic> json) {
    status = json['status'];
...
class ScreenFieldAttr {
  ...
  ScreenFieldAttr.fromJson(Map<String, dynamic> json) {
    ...
    subprojectid = json['subprojectid'] != null
        ? new Name.fromJson(json['subprojectid'])
        : null;
  }
