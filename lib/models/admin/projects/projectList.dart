class ProjectList {
  ...
  ProjectList({this.status, this.body});
...
class ScreenData {
  ...
  List<MultiOccDataProject> multiOccData;
  ...
  ScreenData.fromJson(Map<String, dynamic> json) {
    ...
    if (json['multiOccData'] != null) {
      multiOccData = new List<MultiOccDataProject>();
      json['multiOccData'].forEach((v) {
        multiOccData.add(new MultiOccDataProject.fromJson(v));
      });
    }
  }
...
class MultiOccDataProject {
  ...
  MultiOccDataProject(
      {this.projectid, this.name, this.enddate, this.startdate, this.actions});

  MultiOccDataProject.fromJson(Map<String, dynamic> json) {
