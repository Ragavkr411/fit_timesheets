class AddActivitiesProjGroupDropDown {
  String status;
  Body body;

  AddActivitiesProjGroupDropDown({this.status, this.body});

  AddActivitiesProjGroupDropDown.fromJson(Map<String, dynamic> json) {
    status = json['status'];
