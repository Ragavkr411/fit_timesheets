class UpdateActivityProjGroup {
  ...
  UpdateActivityProjGroup({this.screenName, this.language, this.mode,  this.headerMode, this.headerFieldMap, this.respondWithSummary}){
    if(screenObject==null){
      screenObject=ScreenObject();
    }
  }

  UpdateActivityProjGroup.fromJson(Map<String, dynamic> json) {
